-- Fix create_receipt: execute as SECURITY DEFINER to bypass RLS and fetch admin settings
...
BEGIN
  ...
  -- (Since this is SECURITY DEFINER, it bypasses RLS and can successfully read the admin profile and settings)
