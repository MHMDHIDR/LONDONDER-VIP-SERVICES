-- Drop the old function signature and recreate with all optional params having defaults
-- This fixes the PostgREST schema cache mismatch when some params are omitted
DROP FUNCTION IF EXISTS public.create_payout(DATE, UUID, TEXT, UUID, JSONB, TEXT);
...
BEGIN
  ...
  INSERT INTO public.payouts (
    ...
    worker_id, worker_number_snapshot, worker_phone_snapshot, 
    notes,
    ...
    _worker_id, _worker.worker_number, _worker.phone,
